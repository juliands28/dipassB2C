...
<div class="container">
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-item active">
            <img class="d-block w-100" src="/images/header1.jpg" wit alt="First slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="/images/header1.jpg" width="30%" alt="Second slide">
        </div>
        <div class="carousel-item">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="full-width" data-placeholder="Pilih tujuan Keberangkatan " name='to' data-init-plugin="select2" required>
                                            @foreach ($kota as $item)
                                                <option value="{{$item->id}}">{{$item->city_name}}</option>
                                            @endforeach
                                      </select>
